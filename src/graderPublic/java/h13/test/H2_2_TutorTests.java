...
import h13.Package;
import h13.noise.DecoratorPerlinNoise;
...
public class H2_2_TutorTests {
     ...
     */
    private static final Class<?> CLASS = DecoratorPerlinNoise.class;
    ...
    public void testDelegate() throws Exception {
        ...
        DecoratorPerlinNoise noise = new DecoratorPerlinNoise(underlying) {
