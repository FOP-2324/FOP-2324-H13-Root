 ...
 * <p>
 * The normalization is applied to the output of the specified Perlin noise object by dividing the noise value by 2
 * and then adding 0.5. This transformation maps the noise range [-1, 1] to the normalized range [0, 1].
 * <p>
 * The class implements the PerlinNoise interface by forwarding method calls to the wrapped Perlin noise object.
